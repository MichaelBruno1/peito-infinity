...
fun ExerciseEntity.toDomain() = Exercise(
    ...
    aliases = Json.decodeFromString<List<String>>(aliases),
    ...
    primaryMuscles = Json.decodeFromString<List<String>>(primaryMuscles),
    secondaryMuscles = Json.decodeFromString<List<String>>(secondaryMuscles),
    stabilizers = Json.decodeFromString<List<String>>(stabilizers),
    ...
    redundantWith = Json.decodeFromString<List<String>>(redundantWith),
    goodPairings = Json.decodeFromString<List<String>>(goodPairings),
    avoidAfter = Json.decodeFromString<List<String>>(avoidAfter),
